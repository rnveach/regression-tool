...
public final class CustomCheckProcessor {
     ...
     *
     * <p>The custom check needs a {@code public static} function to retrieve the processing
     * result and to send parameters to. Violations will be used as errors produced by the
     * check.</p>
    ...
    public static void process(String path, Class<?> checkClass) throws CheckstyleException {
        ...
        checker.addListener(new CustomCheckLogger());
